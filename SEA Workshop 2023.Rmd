...
[Australian Animal Acoustic Telemetry Database](https://animaltracking.aodn.org.au) maintained by IMOS ATF houses acoustic telemetry datasets collected 
...
not always interchangeable when using with **R** packages. In addition to this, new formats have now been developed via the ***Fathom*** platform to 
effectively store and export data.
