...
3.  Working with **Spatial objects** using the [*sf*](https://r-spatial.github.io/sf/), [*ggspatial*](https://paleolimbot.github.io/ggspatial/) and [*mapview*](https://r-spatial.github.io/mapview/) **R** packages
...
#### 1.3. Working with Spatial objects using the ***sf***, ***ggspatial*** and ***mapview*** R packages
