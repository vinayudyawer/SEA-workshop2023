...
2.  Working with **Spatial objects** using the [*sf*](https://r-spatial.github.io/sf/), [*ggspatial*](https://paleolimbot.github.io/ggspatial/) and
    [*mapview*](https://r-spatial.github.io/mapview/) **R** packages
...
the image above. These animals were captured and tagged within Cleveland Bay, Townsville roughly one month prior to the landfall of Cyclone Yasi in
...
data to this map. In this case lets plot a bubble plot showing numbers of detections for each individual tracked:
...
We can use other functions from the `leaflet` package to modify our 
