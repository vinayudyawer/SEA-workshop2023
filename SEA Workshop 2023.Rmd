...
**You will find the datasets we will use for this session in the "data" folder in your downloaded zip file, under the subfolder "Session 1".**
**Alternatively, you can download the two .csv data files from [here](https://raw.githubusercontent.com/vinayudyawer/SEA-workshop2023/main/data/Session%201/Station_information.csv) and [here]('https://raw.githubusercontent.com/vinayudyawer/SEA-workshop2023/main/data/Session%201/Blacktip_ClevelandBay.csv').**
